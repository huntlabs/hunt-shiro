...
module hunt.shiro.authc.AuthenticationInfo;
 ...
 * has a parallel {@link hunt.shiro.authz.AuthorizationInfo AuthorizationInfo} interface for use during the
 * authorization process that references access control data such as roles and permissions.
 * <p/>
 * But because many if not most {@link hunt.shiro.realm.Realm Realm}s store both sets of data for a Subject, it might be
