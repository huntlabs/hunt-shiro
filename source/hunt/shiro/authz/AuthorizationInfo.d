 ...
 * {@link hunt.shiro.authz.permission.PermissionResolver PermissionResolver}</li>
 ...
 * {@link hunt.shiro.authc.AuthenticationInfo AuthenticationInfo} interface for use during the authentication
 * process that represents identity data such as principals and credentials.
 * <p/>
 * Because many if not most {@link hunt.shiro.realm.Realm Realm}s store both sets of data for a Subject, it might be
 * convenient for a <code>Realm</code> implementation to utilize an implementation of the
 * {@link hunt.shiro.authc.Account Account} interface instead, which is a convenience interface that combines both
...
interface AuthorizationInfo : Serializable {
     ...
     * {@link hunt.shiro.authz.permission.PermissionResolver PermissionResolver}
