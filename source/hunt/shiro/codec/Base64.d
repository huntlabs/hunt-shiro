...
class Base64 {
     ...
     * The base length.
     */
    private enum int BASELENGTH = 255;

    /**
     * Lookup length.
     */
    private enum int LOOKUPLENGTH = 64;

    /**
     * Used to calculate the number of bits in a byte.
     */
    private enum int EIGHTBIT = 8;

    /**
     * Used when encoding something which has fewer than 24 bits.
     */
    private enum int SIXTEENBIT = 16;

    /**
     * Used to determine how many bits data contains.
     */
    private enum int TWENTYFOURBITGROUP = 24;

    /**
     * Used to get the number of Quadruples.
     */
    private enum int FOURBYTE = 4;

    /**
     * Used to test the sign of a byte.
     */
    private enum int SIGN = -128;

    /**
     * Byte used to pad output.
     */
    private enum byte PAD = '=';
    ...
    //  */
    // static bool isBase64(byte[] arrayOctect) {
