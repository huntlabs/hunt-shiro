 ...
 * under the License.
 */
module hunt.shiro.codec.CodecSupport;
...
abstract class CodecSupport {
    ...
    //  */
    // static byte[] toBytes(char[] chars, String encoding) throws CodecException {
    ...
    //  * @throws CodecException if the JVM does not support the specified encoding.
    //  */
    // static String toString(byte[] bytes, String encoding) throws CodecException {
    //     try {
    ...
    //  * @throws CodecException if the JVM does not support the specified encoding.
    //  */
    // static char[] toChars(byte[] bytes, String encoding) throws CodecException {
