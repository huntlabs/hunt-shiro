...
abstract class IniFactorySupport(T) : AbstractFactory!(T) {
    ...
    enum string DEFAULT_INI_RESOURCE_PATH = "shiro.ini";
     ...
     * @since 1.4
     */
    protected Map!(string, T) getDefaults() {
        return defaultBeans;
    }
     ...
     */
     static Ini loadDefaultClassPathIni() {
        Ini ini = Ini.fromResourcePath(DEFAULT_INI_RESOURCE_PATH);
