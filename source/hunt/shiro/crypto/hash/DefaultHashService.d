 ...
 * {@link #setRandomNumberGenerator(hunt.shiro.crypto.RandomNumberGenerator) randomNumberGenerator} property.
...
class DefaultHashService : ConfigurableHashService {
    ...
    Hash computeHash(HashRequest request) {
        if (request  is null || request.getSource()  is null || request.getSource().isEmpty()) {
            return null;
        }
