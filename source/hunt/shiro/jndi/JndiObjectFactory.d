 ...
 * under the License.
 */
module hunt.shiro.jndi.JndiObjectFactory;
 ...
 * @since 1.2
 */
class JndiObjectFactory(T) : JndiLocator, Factory!(T) {
     ...
     T getInstance() {
        try {
            if(requiredType != null) {
                return cast(requiredType)(this.lookup(resourceName, requiredType));
            } else {
                return cast(T) this.lookup(resourceName);
            }
