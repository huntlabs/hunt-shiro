 ...
 * {@link #setSerializer(hunt.shiro.io.Serializer) serialization} and
...
abstract class AbstractRememberMeManager : RememberMeManager {
     ...
     * <li>{@code token}.{@link hunt.shiro.authc.RememberMeAuthenticationToken#isRememberMe() isRememberMe()} is
     * {@code true}</li>
     * </ol>
     *
     ...
     * {@link #isRememberMe(hunt.shiro.authc.AuthenticationToken) is a RememberMe} token, the associated identity
     * will be {@link #rememberIdentity(hunt.shiro.subject.Subject, hunt.shiro.authc.AuthenticationToken, hunt.shiro.authc.AuthenticationInfo) remembered}
     ...
     * {@link #rememberIdentity(hunt.shiro.subject.Subject, hunt.shiro.subject.PrincipalCollection)}.
     * <p/>
     ...
     * <p/>
     * This implementation first {@link #serialize(hunt.shiro.subject.PrincipalCollection) serializes} the
    ...
    /**
     * Reacts to a failed login by immediately {@link #forgetIdentity(hunt.shiro.subject.Subject) forgetting} any
     ...
     * {@link #forgetIdentity(hunt.shiro.subject.Subject) forgets} any previously stored identity and returns.
     *
