 ...
 * under the License.
 */
module hunt.shiro.mgt.SecurityManager;
 ...
 * single application.
 * <p/>
 * The interface itself primarily exists as a convenience - it extends the {@link hunt.shiro.authc.Authenticator},
 ...
 * {@link Subject} behavior. A {@link hunt.shiro.subject.Subject Subject} executes
 ...
 * {@link hunt.shiro.SecurityUtils#getSubject() SecurityUtils.getSubject()}.
 * <p/>
...
interface SecurityManager : Authenticator, Authorizer, SessionManager {
     ...
     * <code>subject.{@link hunt.shiro.subject.Subject#login login(authenticationToken)}</code> (usually after
     * acquiring the Subject by calling {@link hunt.shiro.SecurityUtils#getSubject() SecurityUtils.getSubject()}).
     * <p/>
