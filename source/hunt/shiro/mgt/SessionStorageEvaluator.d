 ...
 * under the License.
 */
module hunt.shiro.mgt.SessionStorageEvaluator;

import hunt.shiro.subject.Subject;

/**
 * Evaluates whether or not Shiro may use a {@code Subject}'s {@link hunt.shiro.session.Session Session}
...
interface SessionStorageEvaluator {
     ...
     * {@link hunt.shiro.subject.Subject#getSession() session} may be used to persist that Subject's
