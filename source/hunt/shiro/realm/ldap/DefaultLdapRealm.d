 ...
 * under the License.
 */
module hunt.shiro.realm.ldap.DefaultLdapRealm;
...
import hunt.shiro.ldap.UnsupportedAuthenticationMechanismException;
...
/**
 * An LDAP {@link hunt.shiro.realm.Realm Realm} implementation utilizing Sun's/Oracle's
 ...
 * {@link hunt.shiro.authc.AuthenticationToken#getPrincipal() principal} is a simple username, but the
 ...
 * {@link #doGetAuthorizationInfo(hunt.shiro.subject.PrincipalCollection)} implementation returning {@code null}.
 ...
 * <pre>
 * [main]
 * ldapRealm = hunt.shiro.realm.ldap.DefaultLdapRealm
...
class DefaultLdapRealm : AuthorizingRealm {
     ...
     */
     void setUserDnTemplate(string template){
        ...
        if (log.isDebugEnabled()) {
            tracef("Determined user DN prefix [{}] and suffix [{}]", prefix, suffix);
        }
    ...
    protected string getUserDn(string principal){
        ...
        if (prefix  is null && suffix  is null) {
            tracef("userDnTemplate property has not been configured, indicating the submitted " ~
    ...
    /**
     * Delegates to {@link #queryForAuthenticationInfo(hunt.shiro.authc.AuthenticationToken, LdapContextFactory)},
     ...
     * {@link #getLdapPrincipal(hunt.shiro.authc.AuthenticationToken) discovered principal} and provided
     ...
     * {@link #createAuthenticationInfo(hunt.shiro.authc.AuthenticationToken, Object, Object, javax.naming.ldap.LdapContext) created}
    ...
    protected AuthenticationInfo queryForAuthenticationInfo(AuthenticationToken token,
        ...
        tracef("Authenticating user '{}' through LDAP", principal);
