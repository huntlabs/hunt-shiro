 ...
 * {@link #generateSessionId(hunt.shiro.session.Session)} method from within their {@link #doCreate}
 * implementations.
 * <p/>
...
abstract class AbstractSessionDAO : SessionDAO {
     ...
     * {@link #generateSessionId(hunt.shiro.session.Session)} method.
     */
    ...
    /**
     * Returns the {@code SessionIdGenerator} used by the {@link #generateSessionId(hunt.shiro.session.Session)}
     ...
     *
     * @return the {@code SessionIdGenerator} used by the {@link #generateSessionId(hunt.shiro.session.Session)}
     *         method.
     */
    ...
    /**
     * Sets the {@code SessionIdGenerator} used by the {@link #generateSessionId(hunt.shiro.session.Session)}
