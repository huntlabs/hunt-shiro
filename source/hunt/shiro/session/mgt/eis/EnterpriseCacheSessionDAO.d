 ...
 * under the License.
 */
module hunt.shiro.session.mgt.eis.EnterpriseCacheSessionDAO;

import hunt.shiro.cache.AbstractCacheManager;
import hunt.shiro.cache.Cache;
import hunt.shiro.cache.CacheException;
 ...
 * It is expected that an injected {@link hunt.shiro.cache.Cache Cache} or
 * {@link hunt.shiro.cache.CacheManager CacheManager} is backed by an enterprise caching product that can support
