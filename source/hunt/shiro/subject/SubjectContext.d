 ...
 * this data to construct {@link hunt.shiro.subject.Subject Subject} instances.  It is essentially a Map of data
 ...
 * {@link hunt.shiro.mgt.SubjectFactory SubjectFactory} implementation to construct {@code Subject} instances.
...
interface SubjectContext : Map!(string, Object) {
     ...
     * (typically used to support {@link hunt.shiro.subject.support.DelegatingSubject DelegatingSubject} implementations).
     *
     ...
     * instance (typically used to support {@link hunt.shiro.subject.support.DelegatingSubject DelegatingSubject} implementations).
     *
