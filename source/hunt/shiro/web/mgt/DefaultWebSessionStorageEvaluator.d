 ...
 * under the License.
 */
module hunt.shiro.web.mgt.DefaultWebSessionStorageEvaluator;
 ...
 * {@link hunt.shiro.web.filter.session.NoSessionCreationFilter}:  If the {@code NoSessionCreationFilter}
 ...
 * {@code false} from {@link #isSessionStorageEnabled(hunt.shiro.subject.Subject)} method, thereby preventing
...
class DefaultWebSessionStorageEvaluator : DefaultSessionStorageEvaluator {
    ...
    //     if (subject.getSession(false) is null) {
    ...
    //     NativeSessionManager nsm = cast(NativeSessionManager)this.sessionManager;
    //     if (ws is null && (this.sessionManager is null && nsm is null)) {
    //         return false;
    //     }
